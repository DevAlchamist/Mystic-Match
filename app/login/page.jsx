    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-100 to-indigo-200">
      <Card className="w-[350px] shadow-xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-3xl font-bold text-center text-primary">MysticMatch</CardTitle>
          <CardDescription className="text-center text-lg">Connect with your soulmate</CardDescription>
        </CardHeader>
